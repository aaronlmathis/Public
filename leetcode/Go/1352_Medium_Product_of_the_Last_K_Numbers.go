...
func (this *ProductOfNumbers) Add(num int) {
	...
	if num == 0 {
		this.mostRecentZero = len(this.stream)
		this.zero = true
	}
...
func (this *ProductOfNumbers) GetProduct(k int) int {
	if this.mostRecentZero != -1 && (len(this.stream)-k-1) < this.mostRecentZero {
		return 0
	} else if this.mostRecentZero != -1 && (len(this.stream)-k-1) == this.mostRecentZero {
		return this.product[len(this.product)-1]
	}

	return this.product[len(this.product)-1] / this.product[len(this.product)-k-1]
}
